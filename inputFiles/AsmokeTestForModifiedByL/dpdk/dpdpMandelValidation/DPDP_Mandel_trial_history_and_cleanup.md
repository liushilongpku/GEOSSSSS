...
8. 2026-07-29 更新论文版中文主图：改为直接读取 FIM/Seq 完整 HDF5 历程，统一为 `8.02 cm × 5.20 cm`
   版面，增大刻度和线条可读性，减少曲线标记，并采用宋体风格中文字体。最终 PNG/PDF 保存在
   `analitical_result/DPDP_Mandel_压力验证_解析_FIM_迭代耦合.*`。
