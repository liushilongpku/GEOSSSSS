...
是当前 FIM 与解析压力曲线拟合最好的输入，不应误写成无修正物理输入。关于 0.911 的当前定位，
以 `DPDP_Mandel_findings_current_status.md` 为准。
...
| 输入文件 | 用途 |
|---|---|
| `DPDP_N2_dispdriven_fim_eff_direct_mesh10.xml` | FIM 0.911，当前最佳拟合输入 |
