...
#ifndef GEOS_CROSSFLOW_COMPOSITIONAL_THERMALFLUXCOMPUTEKERNEL_HPP
#define GEOS_CROSSFLOW_COMPOSITIONAL_THERMALFLUXCOMPUTEKERNEL_HPP
...
class FluxComputeKernel : public isothermalDualContinuumCompositionalMultiPhaseCrossFlowKernels::FluxComputeKernel< NUM_COMP, NUM_DOF, STENCILWRAPPER >
{
public:
  ...
  using AbstractBase = isothermalDualContinuumCompositionalMultiPhaseCrossFlowKernels::FluxComputeKernelBase;
                    ...
                    StackVariables & stack ) const
  {
                                           ...
                                           real64 const (&dPhaseFlux_dC)[2][numComp] )
    {
      ...
      for( integer i = 0; i < numFluxSupportPoints; ++i )
      {
        ...
        if( AbstractBase::m_kernelFlags.isSet( isothermalDualContinuumCompositionalMultiPhaseCrossFlowKernels::KernelFlags::CapPressure ) )
        {
...
#endif //GEOS_CROSSFLOW_COMPOSITIONAL_THERMALFLUXCOMPUTEKERNEL_HPP
