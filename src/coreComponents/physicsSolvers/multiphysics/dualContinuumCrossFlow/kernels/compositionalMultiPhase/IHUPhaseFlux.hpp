                       ...
                       real64 (& dMobility_dC)[numComp] )
{
  ...
  auto const & phaseMob = (upwindDir == 0) ? phaseMob_m : phaseMob_f;
  auto const & dPhaseMob = (upwindDir == 0) ? dPhaseMob_m : dPhaseMob_f;
...
struct computePotentialGravity
{
  ...
  static void compute( localIndex const GEOS_UNUSED_PARAM( numPhase ),
                       ...
                       ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE > > const & phaseVolFrac_m,
                       ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE > > const & phaseVolFrac_f,
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_DC > > const & GEOS_UNUSED_PARAM( dPhaseVolFrac_m ),
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_DC > > const & GEOS_UNUSED_PARAM( dPhaseVolFrac_f ),
                       ElementViewConst< arrayView3d< real64 const, constitutive::cappres::USD_CAPPRES > > const & GEOS_UNUSED_PARAM( phaseCapPressure_m ),
                       ElementViewConst< arrayView3d< real64 const, constitutive::cappres::USD_CAPPRES > > const & GEOS_UNUSED_PARAM( phaseCapPressure_f ),
                       ElementViewConst< arrayView4d< real64 const, constitutive::cappres::USD_CAPPRES_DS > > const & GEOS_UNUSED_PARAM( dPhaseCapPressure_dPhaseVolFrac_m ),
                       ElementViewConst< arrayView4d< real64 const, constitutive::cappres::USD_CAPPRES_DS > > const & GEOS_UNUSED_PARAM( dPhaseCapPressure_dPhaseVolFrac_f ),
                       real64 & pot,
                       ...
                       real64 ( & dPot_dComp )[numFluxSupportPoints][numComp] )
  {
    ...
    isothermalDualContinuumCompositionalMultiPhaseCrossFlowKernels::helpers::
      calculateMeanDensity( ip, seri, sesri, sei,
                            checkPhasePresenceInGravity,
                            phaseVolFrac_m, phaseVolFrac_f, dCompFrac_dCompDens_m, dCompFrac_dCompDens_f,
    ...
    for( localIndex i = 0; i < numFluxSupportPoints; ++i )
    {
      ...
      // Use matrix properties for first support point, fracture for second
      auto const & gravCoef = (i == 0) ? gravCoef_m : gravCoef_f;
...
struct computePotentialCapillary
{
  ...
  static void compute( localIndex const numPhase,
                       ...
                       real64 const (&dTrans_dPres)[2],
                       real64 const GEOS_UNUSED_PARAM( totFlux ),
                       ElementViewConst< arrayView1d< real64 const > > const & GEOS_UNUSED_PARAM( gravCoef_m ),
                       ElementViewConst< arrayView1d< real64 const > > const & GEOS_UNUSED_PARAM( gravCoef_f ),
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_DC > > const &
                       GEOS_UNUSED_PARAM( dCompFrac_dCompDens_m ),
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_DC > > const &
                       GEOS_UNUSED_PARAM( dCompFrac_dCompDens_f ),
                       ElementViewConst< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE > > const &
                       GEOS_UNUSED_PARAM( phaseMassDens_m ),
                       ElementViewConst< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE > > const &
                       GEOS_UNUSED_PARAM( phaseMassDens_f ),
                       ElementViewConst< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_DC > > const &
                       GEOS_UNUSED_PARAM( dPhaseMassDens_m ),
                       ElementViewConst< arrayView4d< real64 const, constitutive::multifluid::USD_PHASE_DC > > const &
                       GEOS_UNUSED_PARAM( dPhaseMassDens_f ),
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_DC > > const & dPhaseVolFrac_m,
                       ElementViewConst< arrayView3d< real64 const, compflow::USD_PHASE_DC > > const & dPhaseVolFrac_f,
                       ElementViewConst< arrayView3d< real64 const, constitutive::cappres::USD_CAPPRES > > const & phaseCapPressure_m,
                       ElementViewConst< arrayView3d< real64 const, constitutive::cappres::USD_CAPPRES > > const & phaseCapPressure_f,
                       ...
                       real64 (& dPot_dComp)[numFluxSupportPoints][numComp] )
  {
    ...
    for( localIndex i = 0; i < numFluxSupportPoints; ++i )
    {
      ...
      // Use matrix properties for first support point, fracture for second
      auto const & phaseCapPressure = (i == 0) ? phaseCapPressure_m : phaseCapPressure_f;
      auto const & dPhaseCapPressure_dPhaseVolFrac = (i == 0) ? dPhaseCapPressure_dPhaseVolFrac_m : dPhaseCapPressure_dPhaseVolFrac_f;
      auto const & dPhaseVolFrac = (i == 0) ? dPhaseVolFrac_m : dPhaseVolFrac_f;
...
public:
  ...
  void computePotentialViscous( localIndex const numPhase,
                                ...
                                real64 & potential )
  {
    GEOS_UNUSED_VAR( pres_m );
    GEOS_UNUSED_VAR( pres_f );
    GEOS_UNUSED_VAR( gravCoef_f );
    GEOS_UNUSED_VAR( phaseMob_m );
    GEOS_UNUSED_VAR( phaseMob_f );
    GEOS_UNUSED_VAR( dCompFrac_dCompDens_f );
    GEOS_UNUSED_VAR( phaseMassDens_f );
    GEOS_UNUSED_VAR( dPhaseMassDens_f );
    GEOS_UNUSED_VAR( dPhaseVolFrac_f );
    GEOS_UNUSED_VAR( phaseCapPressure_f );
    GEOS_UNUSED_VAR( dPhaseCapPressure_dPhaseVolFrac_f );
    GEOS_UNUSED_VAR( hasCapPressure );
    real64 dPot_dP[numFluxSupportPoints]{};
    real64 dPot_dC[numFluxSupportPoints][numComp]{};
    UpwindHelpers::computePotentialViscous::compute< numComp, numFluxSupportPoints >(
      ...
      totalFlux,
      gravCoef_m,
      dCompFrac_dCompDens_m,
      phaseMassDens_m,
      dPhaseMassDens_m,
      dPhaseVolFrac_m,
      phaseCapPressure_m,
      dPhaseCapPressure_dPhaseVolFrac_m,
      potential,
      dPot_dP,
      dPot_dC );
  }
  ...
  void computePotentialGravity( localIndex const numPhase,
                                ...
                                real64 const (&dTrans_dPres)[2],
                                real64 const totalFlux,
                                ElementViewConst< arrayView1d< real64 const > > const & GEOS_UNUSED_PARAM( pres_m ),
                                ElementViewConst< arrayView1d< real64 const > > const & GEOS_UNUSED_PARAM( pres_f ),
                                ElementViewConst< arrayView1d< real64 const > > const & gravCoef_m,
                                ElementViewConst< arrayView1d< real64 const > > const & gravCoef_f,
                                ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE > > const & phaseMob_m,
                                ElementViewConst< arrayView2d< real64 const, compflow::USD_PHASE > > const & GEOS_UNUSED_PARAM( phaseMob_f ),
                                ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_DC > > const & dCompFrac_dCompDens_m,
                                ElementViewConst< arrayView3d< real64 const, compflow::USD_COMP_DC > > const & dCompFrac_dCompDens_f,
                                ElementViewConst< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE > > const & phaseMassDens_m,
                                ElementViewConst< arrayView3d< real64 const, constitutive::multifluid::USD_PHASE > > const & phaseMassDens_f,
