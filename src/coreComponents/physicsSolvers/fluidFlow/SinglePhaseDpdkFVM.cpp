...
/**
 * @file SinglePhaseDpdkFVM.cpp
 */

#include "SinglePhaseDpdkFVM.hpp"
...
SinglePhaseDpdkFVM< BASE >::SinglePhaseDpdkFVM( const string & name,
                                        Group * const parent ):
  BASE( name, parent )
{
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::initializePreSubGroups()
{
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::setupDofs( DomainPartition const & domain,
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::setupSystem( DomainPartition & domain,
...
SinglePhaseDpdkFVM< BASE >::createPreconditioner( DomainPartition & domain ) const
{
...
template< typename BASE >
real64 SinglePhaseDpdkFVM< BASE >::calculateResidualNorm( real64 const & GEOS_UNUSED_PARAM( time_n ),
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::applySystemSolution( DofManager const & dofManager,
...
template<>
void SinglePhaseDpdkFVM<>::assembleFluxTerms( real64 const dt,
                                          DomainPartition const & domain,
                                          DofManager const & dofManager,
                                          ...
                                          arrayView1d< real64 > const & localRhs )
{
  ...
  string const & dofKey = dofManager.getKey( SinglePhaseBaseDpdk::viewKeyStruct::elemDofFieldString() );
...
template< >
void SinglePhaseDpdkFVM< SinglePhaseBaseDpdk >::assembleStabilizedFluxTerms( real64 const dt,
                                                                     DomainPartition const & domain,
                                                                     DofManager const & dofManager,
                                                                     CRSMatrixView< real64, globalIndex const > const & localMatrix,
                                                                     arrayView1d< real64 > const & localRhs )
...
/*
template<>
void SinglePhaseDpdkFVM< SinglePhaseProppantBase >::assembleFluxTerms( real64 const dt,
                                                                   DomainPartition const & domain,
                                                                   DofManager const & dofManager,
                                                                   CRSMatrixView< real64, globalIndex const > const & localMatrix,
                                                                   arrayView1d< real64 > const & localRhs )
...
template< >
void SinglePhaseDpdkFVM< SinglePhaseProppantBase >::assembleStabilizedFluxTerms( real64 const dt,
                                                                             DomainPartition const & domain,
                                                                             DofManager const & dofManager,
                                                                             CRSMatrixView< real64, globalIndex const > const & localMatrix,
                                                                             arrayView1d< real64 > const & localRhs )
...
*/
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::assembleEDFMFluxTerms( real64 const GEOS_UNUSED_PARAM ( time_n ),
                                                    real64 const dt,
                                                    DomainPartition const & domain,
                                                    DofManager const & dofManager,
                                                    CRSMatrixView< real64, globalIndex const > const & localMatrix,
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::assembleHydrofracFluxTerms( real64 const GEOS_UNUSED_PARAM ( time_n ),
                                                         real64 const dt,
                                                         DomainPartition const & domain,
                                                         DofManager const & dofManager,
                                                         CRSMatrixView< real64, globalIndex const > const & localMatrix,
...
template< typename BASE >
void
SinglePhaseDpdkFVM< BASE >::applyBoundaryConditions( real64 const time_n,
                                                 real64 const dt,
                                                 DomainPartition & domain,
                                                 DofManager const & dofManager,
                                                 CRSMatrixView< real64, globalIndex const > const & localMatrix,
...
char const faceBcLogMessage[] =
  "SinglePhaseDpdkFVM {}: at time {}s, "
  "the <{}> boundary condition '{}' is applied to the face set '{}' in '{}'. "
  "\nThe total number of target faces (including ghost faces) is {}. "
  "\nNote that if this number is equal to zero, the boundary condition will not be applied on this face set.";

GEOS_MAYBE_UNUSED char const incompleteBCLogmessage[] = "SinglePhaseDpdkFVM {}: at time {}, one or more Face boundary conditions are not complete. "
...
template< typename BASE >
void SinglePhaseDpdkFVM< BASE >::applyFaceDirichletBC( real64 const time_n,
                                                   real64 const dt,
                                                   DofManager const & dofManager,
                                                   DomainPartition & domain,
                                                   CRSMatrixView< real64, globalIndex const > const & localMatrix,
...
/*
template<>
void SinglePhaseDpdkFVM< SinglePhaseProppantBase >::applyAquiferBC( real64 const GEOS_UNUSED_PARAM( time ),
                                                                real64 const GEOS_UNUSED_PARAM( dt ),
...
*/
template<>
void SinglePhaseDpdkFVM<>::applyAquiferBC( real64 const time,
                                       real64 const dt,
                                       DomainPartition & domain,
                                       DofManager const & dofManager,
                                       CRSMatrixView< real64, globalIndex const > const & localMatrix,
...
{
      /*
typedef SinglePhaseDpdkFVM< SinglePhaseProppantBase > SinglePhaseFVMProppant;
REGISTER_CATALOG_ENTRY( PhysicsSolverBase, SinglePhaseFVMProppant, string const &, Group * const )
*/
typedef SinglePhaseDpdkFVM<> SinglePhaseDpdkFVM;
REGISTER_CATALOG_ENTRY( PhysicsSolverBase, SinglePhaseDpdkFVM, string const &, Group * const )
}
} /* namespace geos */
