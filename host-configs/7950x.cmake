...
set(ENABLE_HYPRE ON CACHE PATH "" FORCE )
# TPLs
...
if(NOT ( EXISTS "${GEOS_TPL_DIR}" AND IS_DIRECTORY "${GEOS_TPL_DIR}" ) )
   ...
   set(GEOS_TPL_DIR "/home/lsl/code/thirdPartyLibs/install-quick-start-template-debug" CACHE PATH "" FORCE )
endif()
